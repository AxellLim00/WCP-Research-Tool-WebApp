  ...
  $.fn.tableExport = function (options) {
            ...
            ForEachVisibleCell(
              ...
              function (cell, row, col) {
                if (cell !== null) {
                  ...
                  if (defaults.mso.styles.length) {
                    cellStyles = document.defaultView.getComputedStyle(
                      cell,
                      null
                    );
                    rowStyles = null;
                    ...
                    for (let cssStyle in defaults.mso.styles) {
                      ...
                      if (tdCss === "") {
                        if (rowStyles === null)
                          rowStyles = document.defaultView.getComputedStyle(
                            $row[0],
                            null
                          );
    ...
    function saveToFile(data, fileName, type, charset, encoding, bom) {
      ...
      if (saveIt) {
        try {
          if (bom)
            blob = new Blob([String.fromCharCode(0xfeff), [data]], {
              type: type + ";charset=" + charset,
            });
          else blob = new Blob([data], { type: type + ";charset=" + charset });
